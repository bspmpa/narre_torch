...
parser.add_argument("--valid_data", default = "/code/r9/xai/NARRE/data/kindle/music_valid.csv", help = "Data for validation")
parser.add_argument("--test_data", default = "/code/r9/xai/NARRE/data/kindle/music_test.csv", help = "Data parameters")
parser.add_argument("--train_data", default = "/code/r9/xai/NARRE/data/kindle/music_train.csv", help = "Data for training")

parser.add_argument("--user_review", default = '/code/r9/xai/NARRE/data/kindle/user_review', help = "User's reviews") # 300
parser.add_argument("--item_review", default = '/code/r9/xai/NARRE/data/kindle/item_review', help = "Item's reviews")
parser.add_argument("--user_review_id", default = '/code/r9/xai/NARRE/data/kindle/user_rid', help =  "Number of filters per filter size") # 100
parser.add_argument("--item_review_id", default = '/code/r9/xai/NARRE/data/kindle/item_rid', help = "Dropout keep probability ")
...
if __name__ == '__main__':
    ...
    TPS_DIR = '/code/r9/xai/NARRE/data/kindle/'
